...
export const THEMES = {
   ...
   * Note: These values mirror base.css :root defaults for consistency.
   * CSS is not generated for the default theme (uses :root), but values here
   * ensure the configuration is complete and consistent.
   */
  default: {
    name: 'Default',
    ...
    light: {
      ...
      typeTimer: '#3B82F6',
      typeTimerSubtle: '#DBEAFE',
      typeCounter: '#F59E0B',
      typeCounterSubtle: '#FEF3C7',
      typeCheckbox: '#10B981',
      typeCheckboxSubtle: '#D1FAE5',
      typeAvoidance: '#8B5CF6',
    ...
    dark: {
      ...
      accentText: '#A7F3D0',
      info: '#60A5FA',
      infoSubtle: 'rgba(96, 165, 250, 0.2)',
      warning: '#FBBF24',
      warningHover: '#F59E0B',
      warningSubtle: 'rgba(251, 191, 36, 0.2)',
      typeTimer: '#60A5FA',
      typeTimerSubtle: 'rgba(96, 165, 250, 0.2)',
      typeCounter: '#FBBF24',
      typeCounterSubtle: 'rgba(251, 191, 36, 0.2)',
      typeCheckbox: '#34D399',
      typeCheckboxSubtle: 'rgba(52, 211, 153, 0.2)',
      typeAvoidance: '#A78BFA',
      typeAvoidanceSubtle: 'rgba(167, 139, 250, 0.2)',
      heatmap0: '#2e2e2e',
      heatmap1: '#0A5D47',
      heatmap2: '#34D399',
      heatmap3: '#6EE7B7',
  ...
  ocean: {
    ...
    light: {
      ...
      warning: '#0096C7',
      warningHover: '#0077B6',
      warningSubtle: '#CAF0F8',
      typeTimer: '#00B4D8',
      typeTimerSubtle: '#CAF0F8',
      typeCounter: '#48CAE4',
      typeCounterSubtle: '#ADE8F4',
      typeCheckbox: '#0077B6',
      typeCheckboxSubtle: '#90E0EF',
      typeAvoidance: '#023E8A',
      typeAvoidanceSubtle: '#CAF0F8',
      heatmap0: '#D0E8EE',
      heatmap1: '#CAF0F8',
      heatmap2: '#90E0EF',
      heatmap3: '#00B4D8',
    ...
    dark: {
      ...
      warning: '#48CAE4',
      warningHover: '#90E0EF',
      warningSubtle: 'rgba(72, 202, 228, 0.25)',
      typeTimer: '#48CAE4',
      typeTimerSubtle: 'rgba(72, 202, 228, 0.25)',
      typeCounter: '#90E0EF',
      typeCounterSubtle: 'rgba(144, 224, 239, 0.25)',
      typeCheckbox: '#00B4D8',
      typeCheckboxSubtle: 'rgba(0, 180, 216, 0.25)',
      typeAvoidance: '#0077B6',
      typeAvoidanceSubtle: 'rgba(0, 119, 182, 0.25)',
      heatmap0: '#2e2e2e',
      heatmap1: '#0A5272',
      heatmap2: '#0088CC',
      heatmap3: '#00B4D8',
  ...
  forest: {
    ...
    light: {
      ...
      warning: '#8BC34A',
      warningHover: '#7CB342',
      warningSubtle: '#DCEDC8',
      typeTimer: '#7CB342',
      typeTimerSubtle: '#E8F5E0',
      typeCounter: '#9CCC65',
      typeCounterSubtle: '#DCEDC8',
      typeCheckbox: '#4A7C23',
      typeCheckboxSubtle: '#D4E9C7',
      typeAvoidance: '#33691E',
      typeAvoidanceSubtle: '#D4E9C7',
      heatmap0: '#f7f7f7',
      heatmap1: '#E8F5E0',
      heatmap2: '#C5E1A5',
      heatmap3: '#7CB342',
    ...
    dark: {
      ...
      warning: '#AED581',
      warningHover: '#C5E1A5',
      warningSubtle: 'rgba(174, 213, 129, 0.25)',
      typeTimer: '#9CCC65',
      typeTimerSubtle: 'rgba(156, 204, 101, 0.25)',
      typeCounter: '#AED581',
      typeCounterSubtle: 'rgba(174, 213, 129, 0.25)',
      typeCheckbox: '#7CB342',
      typeCheckboxSubtle: 'rgba(124, 179, 66, 0.25)',
      typeAvoidance: '#558B2F',
      typeAvoidanceSubtle: 'rgba(85, 139, 47, 0.25)',
      heatmap0: '#2e2e2e',
      heatmap1: '#2A4A1A',
      heatmap2: '#5A8C33',
      heatmap3: '#7CB342',
  ...
  sunset: {
    ...
    light: {
      ...
      typeAvoidance: '#E65100',
      typeAvoidanceSubtle: '#FFE0B2',
      heatmap0: '#f7f7f7',
      heatmap1: '#FFE0B2',
      heatmap2: '#FFCC80',
      heatmap3: '#FF9800',
    ...
    dark: {
      ...
      accentText: '#FFCCBC',
      info: '#FFB74D',
      infoSubtle: 'rgba(255, 183, 77, 0.25)',
      warning: '#FFB74D',
      warningHover: '#FFA726',
      ...
      typeAvoidance: '#FF8A50',
      typeAvoidanceSubtle: 'rgba(255, 138, 80, 0.25)',
      heatmap0: '#2e2e2e',
      heatmap1: '#5A2E17',
      heatmap2: '#CF460C',
      heatmap3: '#E65100',
  ...
  lavender: {
    ...
    light: {
      ...
      warning: '#8B5CF6',
      warningHover: '#7C3AED',
      warningSubtle: '#EDE9FE',
      typeTimer: '#A78BFA',
      typeTimerSubtle: '#EDE9FE',
      typeCounter: '#C4B5FD',
      typeCounterSubtle: '#F5F3FF',
      typeCheckbox: '#8B5CF6',
    ...
    dark: {
      ...
      warning: '#C4B5FD',
      warningHover: '#DDD6FE',
      warningSubtle: 'rgba(196, 181, 253, 0.25)',
      typeTimer: '#C4B5FD',
      typeTimerSubtle: 'rgba(196, 181, 253, 0.25)',
      typeCounter: '#DDD6FE',
      typeCounterSubtle: 'rgba(221, 214, 254, 0.25)',
      typeCheckbox: '#A78BFA',
