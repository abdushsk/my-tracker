...
export const THEMES = {
  ...
  ocean: {
    ...
    dark: {
      ...
      accentText: '#90E0EF',
      info: '#48CAE4',
      infoSubtle: 'rgba(72, 202, 228, 0.15)',
      typeTimer: '#48CAE4',
      typeTimerSubtle: 'rgba(72, 202, 228, 0.15)',
      typeCheckbox: '#00B4D8',
      typeCheckboxSubtle: 'rgba(0, 180, 216, 0.15)',
      heatmap1: '#023E5C',
      heatmap2: '#0077B6',
      heatmap3: '#00B4D8',
      heatmap4: '#48CAE4',
  ...
  forest: {
    ...
    dark: {
      ...
      accentHover: '#9CCC65',
      accentActive: '#AED581',
      accentSubtle: 'rgba(124, 179, 66, 0.15)',
      accentText: '#AED581',
      info: '#9CCC65',
      infoSubtle: 'rgba(156, 204, 101, 0.15)',
      typeTimer: '#9CCC65',
      typeTimerSubtle: 'rgba(156, 204, 101, 0.15)',
      typeCheckbox: '#7CB342',
      typeCheckboxSubtle: 'rgba(124, 179, 66, 0.15)',
      heatmap1: '#1E3A0F',
      heatmap2: '#4A7C23',
      heatmap3: '#7CB342',
      heatmap4: '#9CCC65',
  ...
  sunset: {
    ...
    dark: {
      ...
      accentHover: '#FFAB91',
      accentActive: '#FFCCBC',
      accentSubtle: 'rgba(255, 138, 80, 0.15)',
      accentText: '#FFCCBC',
      warning: '#FFB74D',
      warningSubtle: 'rgba(255, 183, 77, 0.15)',
      typeTimer: '#FFB74D',
      typeTimerSubtle: 'rgba(255, 183, 77, 0.15)',
      typeCounter: '#FF8A50',
      typeCounterSubtle: 'rgba(255, 138, 80, 0.15)',
      typeCheckbox: '#FF8A50',
      typeCheckboxSubtle: 'rgba(255, 138, 80, 0.15)',
      heatmap1: '#4A1E07',
      heatmap2: '#BF360C',
      heatmap3: '#E65100',
      heatmap4: '#FF8A50',
  ...
  lavender: {
    ...
    dark: {
      ...
      accentText: '#DDD6FE',
      info: '#C4B5FD',
      infoSubtle: 'rgba(196, 181, 253, 0.15)',
      typeTimer: '#C4B5FD',
      typeTimerSubtle: 'rgba(196, 181, 253, 0.15)',
      typeCheckbox: '#A78BFA',
      typeCheckboxSubtle: 'rgba(167, 139, 250, 0.15)',
      typeAvoidance: '#A78BFA',
      typeAvoidanceSubtle: 'rgba(167, 139, 250, 0.15)',
      heatmap1: '#2D1F5B',
      heatmap2: '#5B21B6',
      heatmap3: '#7C3AED',
      heatmap4: '#A78BFA',
